...
  const [error, setError] = useState<string | null>(null); // State istifadə olunmasa da, yerində qalıb
...
      isMounted = false;
    };
  }, [currentPage, sortCol, sortDir, debouncedSearchTerm]); // <-- Əsas trigger debouncedSearchTerm-dur
...
                setCurrentPage(1); // Axtarış başlayanda səhifəni sıfırlamaq
              }}
