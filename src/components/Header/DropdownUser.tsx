    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <FaRegCircleUser className="h-10 w-10 dark:text-gray-400 text-black-2" />
        </span>
      ...
      {dropdownOpen && (
        ...
        >
          <ul className="flex flex-col gap-5 border-b border-stroke px-3.5 py-2.5 dark:border-strokedark">
            <li>
              <Link
                to="/profile"
